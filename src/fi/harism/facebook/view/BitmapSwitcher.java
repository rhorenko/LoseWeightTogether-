...
public class BitmapSwitcher extends View {
	...
	public BitmapSwitcher(Context context) {
		super(context);
		init();
	}

	public BitmapSwitcher(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BitmapSwitcher(Context context, AttributeSet attrs, int defStyle) {
