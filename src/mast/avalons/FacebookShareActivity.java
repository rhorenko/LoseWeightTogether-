...
import fi.harism.facebook.PostActivity;
import fi.harism.facebook.UserActivity;
...
public class FacebookShareActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		title.setText(getIntent().getStringExtra(
				"mast.avalons.FacebookShareActivity.title"));

		mFeedPath = getIntent().getStringExtra(
				"mast.avalons.FacebookShareActivity.path");
		final FBFeed fbFeed = getGlobalState().getFBFactory()
				.getFeed(mFeedPath);
		final Activity self = this;

		View updateButton = findViewById(R.id.StatusEditText);
	...
	private View createPostView(FBPost post) {
		...
		Log.d("TESTPOST", ""+post.getMessage());
